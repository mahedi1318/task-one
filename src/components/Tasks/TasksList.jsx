...
export default function TasksList({tasks, onEdit, onSingleDeleteData, onFave}) {
            ...
            <table className="table-fixed overflow-auto xl:w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr key={task.id} className="border-b border-[#2E3443] [&>td]:align-baseline [&>td]:px-4 [&>td]:py-2">
                                        <td>  
                                            <button onClick={()=>onFave(task)}>
                                                {task.isFavorite ? 
                                                (<MdStar className="text-2xl inline-block text-yellow-500 align-middle"/>  )
                                                :
                                                (<MdStar className="text-2xl inline-block text-gray-500 align-middle"/>  )
                                                }
